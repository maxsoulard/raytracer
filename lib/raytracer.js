...
module.exports = {
    ...
    _computePixel: function(pixel, ray, level) {
        ...
        return currentSphere ? this._computePixelColor(pixel, currentSphere, closest) : {color: {r: 255, g: 255, b: 255}};
    },

    _computePixelColor: function(pixel, currentSphere, closest) {
